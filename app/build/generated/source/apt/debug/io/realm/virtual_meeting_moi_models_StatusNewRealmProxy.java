...
public class virtual_meeting_moi_models_StatusNewRealmProxy extends virtual.meeting.moi.models.StatusNew
    implements RealmObjectProxy, virtual_meeting_moi_models_StatusNewRealmProxyInterface {
    ...
    private ProxyState<virtual.meeting.moi.models.StatusNew> proxyState;
    private RealmList<virtual.meeting.moi.models.StatusImageNew> statusImagesRealmList;

    virtual_meeting_moi_models_StatusNewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<virtual.meeting.moi.models.StatusNew>(this);
    ...
    public RealmList<virtual.meeting.moi.models.StatusImageNew> realmGet$statusImages() {
        ...
        if (statusImagesRealmList != null) {
            ...
            statusImagesRealmList = new RealmList<virtual.meeting.moi.models.StatusImageNew>(virtual.meeting.moi.models.StatusImageNew.class, osList, proxyState.getRealm$realm());
            return statusImagesRealmList;
        }
    }
    ...
    public void realmSet$statusImages(RealmList<virtual.meeting.moi.models.StatusImageNew> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<virtual.meeting.moi.models.StatusImageNew> original = value;
                value = new RealmList<virtual.meeting.moi.models.StatusImageNew>();
                for (virtual.meeting.moi.models.StatusImageNew item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                virtual.meeting.moi.models.StatusImageNew linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static virtual.meeting.moi.models.StatusNew createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        virtual.meeting.moi.models.StatusNew obj = realm.createObjectInternal(virtual.meeting.moi.models.StatusNew.class, true, excludeFields);

        final virtual_meeting_moi_models_StatusNewRealmProxyInterface objProxy = (virtual_meeting_moi_models_StatusNewRealmProxyInterface) obj;
        if (json.has("statusImages")) {
            if (json.isNull("statusImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    virtual.meeting.moi.models.StatusImageNew item = virtual_meeting_moi_models_StatusImageNewRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static virtual.meeting.moi.models.StatusNew createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final virtual.meeting.moi.models.StatusNew obj = new virtual.meeting.moi.models.StatusNew();
        final virtual_meeting_moi_models_StatusNewRealmProxyInterface objProxy = (virtual_meeting_moi_models_StatusNewRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$statusImages(new RealmList<virtual.meeting.moi.models.StatusImageNew>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        virtual.meeting.moi.models.StatusImageNew item = virtual_meeting_moi_models_StatusImageNewRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$statusImages().add(item);
                    }
                    reader.endArray();
                }
    ...
    private static virtual_meeting_moi_models_StatusNewRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusNew.class), false, Collections.<String>emptyList());
        io.realm.virtual_meeting_moi_models_StatusNewRealmProxy obj = new io.realm.virtual_meeting_moi_models_StatusNewRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static virtual.meeting.moi.models.StatusNew copyOrUpdate(Realm realm, StatusNewColumnInfo columnInfo, virtual.meeting.moi.models.StatusNew object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.StatusNew) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static virtual.meeting.moi.models.StatusNew copy(Realm realm, StatusNewColumnInfo columnInfo, virtual.meeting.moi.models.StatusNew newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.StatusNew) cachedRealmObject;
        }

        virtual_meeting_moi_models_StatusNewRealmProxyInterface realmObjectSource = (virtual_meeting_moi_models_StatusNewRealmProxyInterface) newObject;

        Table table = realm.getTable(virtual.meeting.moi.models.StatusNew.class);
        ...
        io.realm.virtual_meeting_moi_models_StatusNewRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<virtual.meeting.moi.models.StatusImageNew> statusImagesList = realmObjectSource.realmGet$statusImages();
        if (statusImagesList != null) {
            RealmList<virtual.meeting.moi.models.StatusImageNew> statusImagesRealmList = realmObjectCopy.realmGet$statusImages();
            statusImagesRealmList.clear();
            for (int i = 0; i < statusImagesList.size(); i++) {
                virtual.meeting.moi.models.StatusImageNew statusImagesItem = statusImagesList.get(i);
                virtual.meeting.moi.models.StatusImageNew cachestatusImages = (virtual.meeting.moi.models.StatusImageNew) cache.get(statusImagesItem);
                if (cachestatusImages != null) {
                    statusImagesRealmList.add(cachestatusImages);
                } else {
                    statusImagesRealmList.add(virtual_meeting_moi_models_StatusImageNewRealmProxy.copyOrUpdate(realm, (virtual_meeting_moi_models_StatusImageNewRealmProxy.StatusImageNewColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusImageNew.class), statusImagesItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, virtual.meeting.moi.models.StatusNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.StatusNew.class);
        long tableNativePtr = table.getNativePtr();
        StatusNewColumnInfo columnInfo = (StatusNewColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusNew.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<virtual.meeting.moi.models.StatusImageNew> statusImagesList = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$statusImages();
        if (statusImagesList != null) {
            OsList statusImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.statusImagesIndex);
            for (virtual.meeting.moi.models.StatusImageNew statusImagesItem : statusImagesList) {
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = virtual_meeting_moi_models_StatusImageNewRealmProxy.insert(realm, statusImagesItem, cache);
                }
                statusImagesOsList.addRow(cacheItemIndexstatusImages);
            }
        }
        String realmGet$lastMessage = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$timeUpdated(), false);

        virtual.meeting.moi.models.User userObj = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        virtual.meeting.moi.models.Group groupObj = ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((virtual_meeting_moi_models_StatusNewRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusNewColumnInfo columnInfo = (StatusNewColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusNew.class);
        virtual.meeting.moi.models.StatusNew object = null;
        while (objects.hasNext()) {
            object = (virtual.meeting.moi.models.StatusNew) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, virtual.meeting.moi.models.StatusNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.StatusNew.class);
        ...
        if (statusImagesList != null && statusImagesList.size() == statusImagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = virtual_meeting_moi_models_StatusImageNewRealmProxy.insertOrUpdate(realm, statusImagesItem, cache);
                }
    ...
    public static virtual.meeting.moi.models.StatusNew createDetachedCopy(virtual.meeting.moi.models.StatusNew realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        virtual.meeting.moi.models.StatusNew unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new virtual.meeting.moi.models.StatusNew();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (virtual.meeting.moi.models.StatusNew) cachedObject.object;
            }
            unmanagedObject = (virtual.meeting.moi.models.StatusNew) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        virtual_meeting_moi_models_StatusNewRealmProxyInterface unmanagedCopy = (virtual_meeting_moi_models_StatusNewRealmProxyInterface) unmanagedObject;
        virtual_meeting_moi_models_StatusNewRealmProxyInterface realmSource = (virtual_meeting_moi_models_StatusNewRealmProxyInterface) realmObject;

        // Deep copy of statusImages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$statusImages(null);
        } else {
            RealmList<virtual.meeting.moi.models.StatusImageNew> managedstatusImagesList = realmSource.realmGet$statusImages();
            RealmList<virtual.meeting.moi.models.StatusImageNew> unmanagedstatusImagesList = new RealmList<virtual.meeting.moi.models.StatusImageNew>();
            unmanagedCopy.realmSet$statusImages(unmanagedstatusImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedstatusImagesList.size();
            for (int i = 0; i < size; i++) {
                virtual.meeting.moi.models.StatusImageNew item = virtual_meeting_moi_models_StatusImageNewRealmProxy.createDetachedCopy(managedstatusImagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        virtual_meeting_moi_models_StatusNewRealmProxy aStatusNew = (virtual_meeting_moi_models_StatusNewRealmProxy)o;
