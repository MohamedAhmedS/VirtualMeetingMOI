...
public class virtual_meeting_moi_models_StatusImageRealmProxy extends virtual.meeting.moi.models.StatusImage
    implements RealmObjectProxy, virtual_meeting_moi_models_StatusImageRealmProxyInterface {
    ...
    private ProxyState<virtual.meeting.moi.models.StatusImage> proxyState;

    virtual_meeting_moi_models_StatusImageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<virtual.meeting.moi.models.StatusImage>(this);
    ...
    @SuppressWarnings("cast")
    public static virtual.meeting.moi.models.StatusImage createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        virtual.meeting.moi.models.StatusImage obj = realm.createObjectInternal(virtual.meeting.moi.models.StatusImage.class, true, excludeFields);

        final virtual_meeting_moi_models_StatusImageRealmProxyInterface objProxy = (virtual_meeting_moi_models_StatusImageRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
    ...
    public static virtual.meeting.moi.models.StatusImage createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final virtual.meeting.moi.models.StatusImage obj = new virtual.meeting.moi.models.StatusImage();
        final virtual_meeting_moi_models_StatusImageRealmProxyInterface objProxy = (virtual_meeting_moi_models_StatusImageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static virtual_meeting_moi_models_StatusImageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusImage.class), false, Collections.<String>emptyList());
        io.realm.virtual_meeting_moi_models_StatusImageRealmProxy obj = new io.realm.virtual_meeting_moi_models_StatusImageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static virtual.meeting.moi.models.StatusImage copyOrUpdate(Realm realm, StatusImageColumnInfo columnInfo, virtual.meeting.moi.models.StatusImage object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.StatusImage) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static virtual.meeting.moi.models.StatusImage copy(Realm realm, StatusImageColumnInfo columnInfo, virtual.meeting.moi.models.StatusImage newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.StatusImage) cachedRealmObject;
        }

        virtual_meeting_moi_models_StatusImageRealmProxyInterface realmObjectSource = (virtual_meeting_moi_models_StatusImageRealmProxyInterface) newObject;

        Table table = realm.getTable(virtual.meeting.moi.models.StatusImage.class);
        ...
        io.realm.virtual_meeting_moi_models_StatusImageRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, virtual.meeting.moi.models.StatusImage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.StatusImage.class);
        long tableNativePtr = table.getNativePtr();
        StatusImageColumnInfo columnInfo = (StatusImageColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusImage.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$id = ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$attachmentType(), false);

        virtual.meeting.moi.models.Attachment attachmentObj = ((virtual_meeting_moi_models_StatusImageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusImageColumnInfo columnInfo = (StatusImageColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.StatusImage.class);
        virtual.meeting.moi.models.StatusImage object = null;
        while (objects.hasNext()) {
            object = (virtual.meeting.moi.models.StatusImage) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, virtual.meeting.moi.models.StatusImage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.StatusImage.class);
    ...
    public static virtual.meeting.moi.models.StatusImage createDetachedCopy(virtual.meeting.moi.models.StatusImage realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        virtual.meeting.moi.models.StatusImage unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new virtual.meeting.moi.models.StatusImage();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (virtual.meeting.moi.models.StatusImage) cachedObject.object;
            }
            unmanagedObject = (virtual.meeting.moi.models.StatusImage) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        virtual_meeting_moi_models_StatusImageRealmProxyInterface unmanagedCopy = (virtual_meeting_moi_models_StatusImageRealmProxyInterface) unmanagedObject;
        virtual_meeting_moi_models_StatusImageRealmProxyInterface realmSource = (virtual_meeting_moi_models_StatusImageRealmProxyInterface) realmObject;
