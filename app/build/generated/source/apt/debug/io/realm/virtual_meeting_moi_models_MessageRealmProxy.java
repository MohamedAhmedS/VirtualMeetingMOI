...
public class virtual_meeting_moi_models_MessageRealmProxy extends virtual.meeting.moi.models.Message
    implements RealmObjectProxy, virtual_meeting_moi_models_MessageRealmProxyInterface {
    ...
    private ProxyState<virtual.meeting.moi.models.Message> proxyState;
    private RealmList<String> userIdsRealmList;
    private RealmList<String> grpDeletedMsgIdsRealmList;

    virtual_meeting_moi_models_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<virtual.meeting.moi.models.Message>(this);
    ...
    @Override
    public virtual.meeting.moi.models.Attachment realmGet$attachment() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.attachmentIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(virtual.meeting.moi.models.Attachment.class, proxyState.getRow$realm().getLink(columnInfo.attachmentIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$attachment(virtual.meeting.moi.models.Attachment value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static virtual.meeting.moi.models.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        virtual.meeting.moi.models.Message obj = realm.createObjectInternal(virtual.meeting.moi.models.Message.class, true, excludeFields);

        final virtual_meeting_moi_models_MessageRealmProxyInterface objProxy = (virtual_meeting_moi_models_MessageRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                virtual.meeting.moi.models.Attachment attachmentObj = virtual_meeting_moi_models_AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
    ...
    public static virtual.meeting.moi.models.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final virtual.meeting.moi.models.Message obj = new virtual.meeting.moi.models.Message();
        final virtual_meeting_moi_models_MessageRealmProxyInterface objProxy = (virtual_meeting_moi_models_MessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    virtual.meeting.moi.models.Attachment attachmentObj = virtual_meeting_moi_models_AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$attachment(attachmentObj);
                }
    ...
    private static virtual_meeting_moi_models_MessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Message.class), false, Collections.<String>emptyList());
        io.realm.virtual_meeting_moi_models_MessageRealmProxy obj = new io.realm.virtual_meeting_moi_models_MessageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static virtual.meeting.moi.models.Message copyOrUpdate(Realm realm, MessageColumnInfo columnInfo, virtual.meeting.moi.models.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Message) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static virtual.meeting.moi.models.Message copy(Realm realm, MessageColumnInfo columnInfo, virtual.meeting.moi.models.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Message) cachedRealmObject;
        }

        virtual_meeting_moi_models_MessageRealmProxyInterface realmObjectSource = (virtual_meeting_moi_models_MessageRealmProxyInterface) newObject;

        Table table = realm.getTable(virtual.meeting.moi.models.Message.class);
        ...
        builder.addString(columnInfo.statusUrlIndex, realmObjectSource.realmGet$statusUrl());
        ...
        builder.addBoolean(columnInfo.readMsgIndex, realmObjectSource.realmGet$readMsg());
        builder.addString(columnInfo.replyIdIndex, realmObjectSource.realmGet$replyId());
        builder.addString(columnInfo.deleteIndex, realmObjectSource.realmGet$delete());
        builder.addStringList(columnInfo.userIdsIndex, realmObjectSource.realmGet$userIds());
        builder.addStringList(columnInfo.grpDeletedMsgIdsIndex, realmObjectSource.realmGet$grpDeletedMsgIds());
        builder.addBoolean(columnInfo.isBlockedIndex, realmObjectSource.realmGet$isBlocked());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.virtual_meeting_moi_models_MessageRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        virtual.meeting.moi.models.Attachment attachmentObj = realmObjectSource.realmGet$attachment();
        if (attachmentObj == null) {
            realmObjectCopy.realmSet$attachment(null);
        } else {
            virtual.meeting.moi.models.Attachment cacheattachment = (virtual.meeting.moi.models.Attachment) cache.get(attachmentObj);
            if (cacheattachment != null) {
                realmObjectCopy.realmSet$attachment(cacheattachment);
            } else {
                realmObjectCopy.realmSet$attachment(virtual_meeting_moi_models_AttachmentRealmProxy.copyOrUpdate(realm, (virtual_meeting_moi_models_AttachmentRealmProxy.AttachmentColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Attachment.class), attachmentObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, virtual.meeting.moi.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Message.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$recipientId = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$recipientId();
        ...
        String realmGet$id = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$statusUrl = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$statusUrl();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$attachmentType(), false);

        virtual.meeting.moi.models.Attachment attachmentObj = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = virtual_meeting_moi_models_AttachmentRealmProxy.insert(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readMsgIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$readMsg(), false);
        String realmGet$replyId = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$replyId();
        if (realmGet$replyId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.replyIdIndex, rowIndex, realmGet$replyId, false);
        }
        String realmGet$delete = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$delete();
        if (realmGet$delete != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.deleteIndex, rowIndex, realmGet$delete, false);
        }

        RealmList<java.lang.String> userIdsList = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$userIds();
        if (userIdsList != null) {
        ...
        RealmList<java.lang.String> grpDeletedMsgIdsList = ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$grpDeletedMsgIds();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBlockedIndex, rowIndex, ((virtual_meeting_moi_models_MessageRealmProxyInterface) object).realmGet$isBlocked(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Message.class);
        virtual.meeting.moi.models.Message object = null;
        while (objects.hasNext()) {
            object = (virtual.meeting.moi.models.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, virtual.meeting.moi.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Message.class);
        ...
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = virtual_meeting_moi_models_AttachmentRealmProxy.insertOrUpdate(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        } else {
    ...
    public static virtual.meeting.moi.models.Message createDetachedCopy(virtual.meeting.moi.models.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        virtual.meeting.moi.models.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new virtual.meeting.moi.models.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (virtual.meeting.moi.models.Message) cachedObject.object;
            }
            unmanagedObject = (virtual.meeting.moi.models.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        virtual_meeting_moi_models_MessageRealmProxyInterface unmanagedCopy = (virtual_meeting_moi_models_MessageRealmProxyInterface) unmanagedObject;
        virtual_meeting_moi_models_MessageRealmProxyInterface realmSource = (virtual_meeting_moi_models_MessageRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$attachment(virtual_meeting_moi_models_AttachmentRealmProxy.createDetachedCopy(realmSource.realmGet$attachment(), currentDepth + 1, maxDepth, cache));
