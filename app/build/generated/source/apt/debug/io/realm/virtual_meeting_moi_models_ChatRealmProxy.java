...
public class virtual_meeting_moi_models_ChatRealmProxy extends virtual.meeting.moi.models.Chat
    implements RealmObjectProxy, virtual_meeting_moi_models_ChatRealmProxyInterface {
    ...
    private ProxyState<virtual.meeting.moi.models.Chat> proxyState;
    private RealmList<virtual.meeting.moi.models.Message> messagesRealmList;

    virtual_meeting_moi_models_ChatRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<virtual.meeting.moi.models.Chat>(this);
    ...
    public RealmList<virtual.meeting.moi.models.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<virtual.meeting.moi.models.Message>(virtual.meeting.moi.models.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<virtual.meeting.moi.models.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<virtual.meeting.moi.models.Message> original = value;
                value = new RealmList<virtual.meeting.moi.models.Message>();
                for (virtual.meeting.moi.models.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                virtual.meeting.moi.models.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static virtual.meeting.moi.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        virtual.meeting.moi.models.Chat obj = realm.createObjectInternal(virtual.meeting.moi.models.Chat.class, true, excludeFields);

        final virtual_meeting_moi_models_ChatRealmProxyInterface objProxy = (virtual_meeting_moi_models_ChatRealmProxyInterface) obj;
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    virtual.meeting.moi.models.Message item = virtual_meeting_moi_models_MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static virtual.meeting.moi.models.Chat createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final virtual.meeting.moi.models.Chat obj = new virtual.meeting.moi.models.Chat();
        final virtual_meeting_moi_models_ChatRealmProxyInterface objProxy = (virtual_meeting_moi_models_ChatRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<virtual.meeting.moi.models.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        virtual.meeting.moi.models.Message item = virtual_meeting_moi_models_MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    private static virtual_meeting_moi_models_ChatRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Chat.class), false, Collections.<String>emptyList());
        io.realm.virtual_meeting_moi_models_ChatRealmProxy obj = new io.realm.virtual_meeting_moi_models_ChatRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static virtual.meeting.moi.models.Chat copyOrUpdate(Realm realm, ChatColumnInfo columnInfo, virtual.meeting.moi.models.Chat object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Chat) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static virtual.meeting.moi.models.Chat copy(Realm realm, ChatColumnInfo columnInfo, virtual.meeting.moi.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Chat) cachedRealmObject;
        }

        virtual_meeting_moi_models_ChatRealmProxyInterface realmObjectSource = (virtual_meeting_moi_models_ChatRealmProxyInterface) newObject;

        Table table = realm.getTable(virtual.meeting.moi.models.Chat.class);
        ...
        io.realm.virtual_meeting_moi_models_ChatRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<virtual.meeting.moi.models.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<virtual.meeting.moi.models.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                virtual.meeting.moi.models.Message messagesItem = messagesList.get(i);
                virtual.meeting.moi.models.Message cachemessages = (virtual.meeting.moi.models.Message) cache.get(messagesItem);
                if (cachemessages != null) {
                    messagesRealmList.add(cachemessages);
                } else {
                    messagesRealmList.add(virtual_meeting_moi_models_MessageRealmProxy.copyOrUpdate(realm, (virtual_meeting_moi_models_MessageRealmProxy.MessageColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Message.class), messagesItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, virtual.meeting.moi.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Chat.class);
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Chat.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<virtual.meeting.moi.models.Message> messagesList = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (virtual.meeting.moi.models.Message messagesItem : messagesList) {
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = virtual_meeting_moi_models_MessageRealmProxy.insert(realm, messagesItem, cache);
                }
                messagesOsList.addRow(cacheItemIndexmessages);
            }
        }
        String realmGet$lastMessage = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);

        virtual.meeting.moi.models.User userObj = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        virtual.meeting.moi.models.Group groupObj = ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((virtual_meeting_moi_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Chat.class);
        virtual.meeting.moi.models.Chat object = null;
        while (objects.hasNext()) {
            object = (virtual.meeting.moi.models.Chat) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, virtual.meeting.moi.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Chat.class);
        ...
        if (messagesList != null && messagesList.size() == messagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = virtual_meeting_moi_models_MessageRealmProxy.insertOrUpdate(realm, messagesItem, cache);
                }
    ...
    public static virtual.meeting.moi.models.Chat createDetachedCopy(virtual.meeting.moi.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        virtual.meeting.moi.models.Chat unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new virtual.meeting.moi.models.Chat();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (virtual.meeting.moi.models.Chat) cachedObject.object;
            }
            unmanagedObject = (virtual.meeting.moi.models.Chat) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        virtual_meeting_moi_models_ChatRealmProxyInterface unmanagedCopy = (virtual_meeting_moi_models_ChatRealmProxyInterface) unmanagedObject;
        virtual_meeting_moi_models_ChatRealmProxyInterface realmSource = (virtual_meeting_moi_models_ChatRealmProxyInterface) realmObject;

        // Deep copy of messages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$messages(null);
        } else {
            RealmList<virtual.meeting.moi.models.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<virtual.meeting.moi.models.Message> unmanagedmessagesList = new RealmList<virtual.meeting.moi.models.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                virtual.meeting.moi.models.Message item = virtual_meeting_moi_models_MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        virtual_meeting_moi_models_ChatRealmProxy aChat = (virtual_meeting_moi_models_ChatRealmProxy)o;
