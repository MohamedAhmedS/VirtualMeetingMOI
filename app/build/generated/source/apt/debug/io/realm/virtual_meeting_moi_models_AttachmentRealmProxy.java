...
public class virtual_meeting_moi_models_AttachmentRealmProxy extends virtual.meeting.moi.models.Attachment
    implements RealmObjectProxy, virtual_meeting_moi_models_AttachmentRealmProxyInterface {
    ...
    private ProxyState<virtual.meeting.moi.models.Attachment> proxyState;

    virtual_meeting_moi_models_AttachmentRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<virtual.meeting.moi.models.Attachment>(this);
    ...
    @SuppressWarnings("cast")
    public static virtual.meeting.moi.models.Attachment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        virtual.meeting.moi.models.Attachment obj = realm.createObjectInternal(virtual.meeting.moi.models.Attachment.class, true, excludeFields);

        final virtual_meeting_moi_models_AttachmentRealmProxyInterface objProxy = (virtual_meeting_moi_models_AttachmentRealmProxyInterface) obj;
        if (json.has("name")) {
            if (json.isNull("name")) {
    ...
    public static virtual.meeting.moi.models.Attachment createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final virtual.meeting.moi.models.Attachment obj = new virtual.meeting.moi.models.Attachment();
        final virtual_meeting_moi_models_AttachmentRealmProxyInterface objProxy = (virtual_meeting_moi_models_AttachmentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static virtual_meeting_moi_models_AttachmentRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Attachment.class), false, Collections.<String>emptyList());
        io.realm.virtual_meeting_moi_models_AttachmentRealmProxy obj = new io.realm.virtual_meeting_moi_models_AttachmentRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static virtual.meeting.moi.models.Attachment copyOrUpdate(Realm realm, AttachmentColumnInfo columnInfo, virtual.meeting.moi.models.Attachment object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Attachment) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static virtual.meeting.moi.models.Attachment copy(Realm realm, AttachmentColumnInfo columnInfo, virtual.meeting.moi.models.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (virtual.meeting.moi.models.Attachment) cachedRealmObject;
        }

        virtual_meeting_moi_models_AttachmentRealmProxyInterface realmObjectSource = (virtual_meeting_moi_models_AttachmentRealmProxyInterface) newObject;

        Table table = realm.getTable(virtual.meeting.moi.models.Attachment.class);
        ...
        io.realm.virtual_meeting_moi_models_AttachmentRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, virtual.meeting.moi.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Attachment.class);
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Attachment.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$name = ((virtual_meeting_moi_models_AttachmentRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$data = ((virtual_meeting_moi_models_AttachmentRealmProxyInterface) object).realmGet$data();
        if (realmGet$data != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dataIndex, rowIndex, realmGet$data, false);
        }
        String realmGet$url = ((virtual_meeting_moi_models_AttachmentRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.bytesCountIndex, rowIndex, ((virtual_meeting_moi_models_AttachmentRealmProxyInterface) object).realmGet$bytesCount(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(virtual.meeting.moi.models.Attachment.class);
        virtual.meeting.moi.models.Attachment object = null;
        while (objects.hasNext()) {
            object = (virtual.meeting.moi.models.Attachment) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, virtual.meeting.moi.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(virtual.meeting.moi.models.Attachment.class);
    ...
    public static virtual.meeting.moi.models.Attachment createDetachedCopy(virtual.meeting.moi.models.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        virtual.meeting.moi.models.Attachment unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new virtual.meeting.moi.models.Attachment();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (virtual.meeting.moi.models.Attachment) cachedObject.object;
            }
            unmanagedObject = (virtual.meeting.moi.models.Attachment) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        virtual_meeting_moi_models_AttachmentRealmProxyInterface unmanagedCopy = (virtual_meeting_moi_models_AttachmentRealmProxyInterface) unmanagedObject;
        virtual_meeting_moi_models_AttachmentRealmProxyInterface realmSource = (virtual_meeting_moi_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        virtual_meeting_moi_models_AttachmentRealmProxy aAttachment = (virtual_meeting_moi_models_AttachmentRealmProxy)o;
